...
This file lists the third-party libraries used by GCode and their respective licenses.
GCode itself is licensed under the [MIT License](LICENSE).
...
(~95%) use MIT, ISC, or BSD licenses. All licenses are compatible with GCode's MIT license.
...
GCode is a desktop GUI for [OpenCode](https://github.com/opencode-ai/opencode), an
open-source AI coding agent. GCode integrates with OpenCode via the
[`@opencode-ai/sdk`](https://www.npmjs.com/package/@opencode-ai/sdk) package, which is
licensed under the MIT License.

GCode is not a fork of OpenCode. It spawns and manages the OpenCode server process and
