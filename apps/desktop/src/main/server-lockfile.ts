/**
 * Lockfile for the GCode-managed OpenCode server process.
 *
 * Written when GCode spawns a server, removed on clean shutdown. On next
 ...
 *
 * Path: ~/.local/share/gcode/server.lock
 */
