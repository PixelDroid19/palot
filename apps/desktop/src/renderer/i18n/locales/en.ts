...
export const en = {
	...
	litOnboarding: {
		...
		migrateBody: "Preview and import MCP servers, skills, agents, and rules from Claude Code, Cursor, or OpenCode.",
		noMigrationSources: "No migration sources found on this machine.",
	...
	litSettings: {
		...
		refresh: "Refresh",
		pluginsDesc: "OpenCode plugins (npm package or local path). Written to global managed-runtime config.",
		...
		worktreeBody: "Sandbox worktrees from the managed runtime. Reset or remove without leaving the app.",
		worktreeEmpty: "No worktrees reported by the managed runtime.",
		worktreeReset: "Reset",
