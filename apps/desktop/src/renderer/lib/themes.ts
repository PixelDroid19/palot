...
// Key traits:
//   - Neutral (cool) grays
//   - GCode Blue accent (#05bdf5 base, oklch 228.71 hue)
...
export const cortexTheme: ThemeDefinition = {
	id: "cortex",
	name: "Cortex",
	description: "Cool neutrals with GCode Blue accent, clean and minimal",
	cssVars: {
		light: {
...
//     GCode Blue fallbacks, so they track the OS accent color
