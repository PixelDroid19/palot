...
const IDS = {
	// Projects
	projectGcode: "proj-a1b2c3d4e5f6",
...
const DIRS = {
	gcode: "/Users/demo/Projects/gcode",
...
function assistantMsg(
	...
	return {
		...
		mode: "Adaptive",
		agent: "code",
		path: { cwd: DIRS.gcode, root: DIRS.gcode },
...
export const MOCK_DEFAULT_PROJECT_SLUG = `gcode-${IDS.projectGcode.slice(0, 12)}`
