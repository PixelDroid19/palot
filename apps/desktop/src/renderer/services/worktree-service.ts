...
/** Result shaped for the existing GCode UI (compatible with new-chat.tsx flow) */
...
export async function createWorktree(
	...
	try {
		...
		return {
			...
			worktreeWorkspace,
			branchName: data.branch ?? sessionSlug,
		}
	} catch (err) {
 ...
 * GCode cannot directly access the worktree filesystem.
 *
